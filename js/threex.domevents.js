...
THREEx.DomEvents.prototype._onEvent	= function(eventName, mouseX, mouseY, origDomEvent)
{
	...
	//new snippet to support three r69, taken from here - https://github.com/jeromeetienne/threex.domevents/pull/5/files?diff=split
	// compute the intersection
	var vector = new THREE.Vector3();
	var raycaster = new THREE.Raycaster();
	var dir = new THREE.Vector3();
	...
	//Treshold needs to be greater than 1 (which is the default)in order for the click action to work
	//see http://stackoverflow.com/questions/27864029/clickable-particles-in-three-js-pointcloud
